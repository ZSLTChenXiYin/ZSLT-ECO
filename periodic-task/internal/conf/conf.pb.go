...
type Registry_Consul struct {
	...
	HealthCheck                    string                 `protobuf:"bytes,3,opt,name=health_check,json=healthCheck,proto3" json:"health_check,omitempty"`                                                               // 健康检查路径
	Interval                       *durationpb.Duration   `protobuf:"bytes,4,opt,name=interval,proto3" json:"interval,omitempty"`                                                                                        // 健康检查间隔
	Timeout                        *durationpb.Duration   `protobuf:"bytes,5,opt,name=timeout,proto3" json:"timeout,omitempty"`                                                                                          // 健康检查超时
	DeregisterCriticalServiceAfter bool                   `protobuf:"varint,6,opt,name=deregister_critical_service_after,json=deregisterCriticalServiceAfter,proto3" json:"deregister_critical_service_after,omitempty"` // 是否在服务异常后自动注销
	unknownFields                  protoimpl.UnknownFields
	sizeCache                      protoimpl.SizeCache
}
...
func (x *Registry_Consul) GetHealthCheck() string {
	if x != nil {
...
func (x *Registry_Consul) GetInterval() *durationpb.Duration {
	if x != nil {
		return x.Interval
	}
	return nil
...
func (x *Registry_Consul) GetDeregisterCriticalServiceAfter() bool {
	if x != nil {
...
const file_conf_proto_rawDesc = "" +
	...
	"\bRegistry\x123\n" +
	"\x06consul\x18\x01 \x01(\v2\x1b.kratos.api.Registry.ConsulR\x06consul\x1a\x94\x02\n" +
	"\x06Consul\x12\x18\n" +
	"\aaddress\x18\x01 \x03(\tR\aaddress\x12\x16\n" +
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\x12!\n" +
	"\fhealth_check\x18\x03 \x01(\tR\vhealthCheck\x125\n" +
	...
	"!deregister_critical_service_after\x18\x06 \x01(\bR\x1ederegisterCriticalServiceAfter\"\xdd\x02\n" +
	"\x04Data\x125\n" +
	...
	"\rwrite_timeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutB\"Z periodic-task/internal/conf;confb\x06proto3"
...
var file_conf_proto_depIdxs = []int32{
	...
	9,  // 10: kratos.api.Registry.Consul.interval:type_name -> google.protobuf.Duration
	9,  // 11: kratos.api.Registry.Consul.timeout:type_name -> google.protobuf.Duration
